...
public final class InvokerFiles {
    ...
    // Published invokers, copied unchanged from github.com/opencelium/invoker at commit c2ad4ce.

    /** Declares the operation {@code DeleteAssetTypes} twice. */
    public static final String PUBLISHED_JIRA_ASSET = "v5/published/jiraassetapi.xml";

    /** Declares the field {@code DocumentStatus} twice in several bodies. */
    public static final String PUBLISHED_SAP_B1 = "v5/published/sapb1.xml";

    /** Upgrades without repeated operations or fields. */
    public static final String PUBLISHED_TRELLO = "v5/published/trello.xml";
