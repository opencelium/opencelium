...
INSERT INTO `activity` VALUES (1,'4f3f7b60-3a27-4e8c-ad41-69e3f94494e1','2020-01-22 09:55:36','0');
...
CREATE TABLE `connection` (
  ...
  `from_connector` int(11) NOT NULL,
  `to_connector` int(11) NOT NULL,
...
CREATE TABLE `detail` (
  ...
  `tutorial` tinyint(4) DEFAULT NULL,
...
INSERT INTO `role` VALUES (1,'Admin','Admin role',NULL),(2,'User','Middle sys admin',NULL);
...
CREATE TABLE `role_has_permission` (
  ...
  PRIMARY KEY (`role_id`,`permission_id`,`component_id`),
  KEY `fk_role_has_permission_permission1_idx` (`permission_id`),
  KEY `fk_role_has_permission_role1_idx` (`role_id`),
  KEY `fk_role_has_permission_component1_idx` (`component_id`),
  CONSTRAINT `fk_role_has_permission_component1` FOREIGN KEY (`component_id`) REFERENCES `component` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
INSERT INTO `role_has_permission` VALUES (1,1,1),(1,2,1),(1,3,1),(1,4,1),(1,5,1),(1,6,1),(1,7,1),(1,8,1),(1,9,1),(1,1,2),(1,2,2),(1,3,2),(1,4,2),(1,5,2),(1,6,2),(1,7,2),(1,8,2),(1,9,2),(1,1,3),(1,2,3),(1,3,3),(1,4,3),(1,5,3),(1,6,3),(1,7,3),(1,8,3),(1,9,3),(1,1,4),(1,2,4),(1,3,4),(1,4,4),(1,5,4),(1,6,4),(1,7,4),(1,8,4),(1,9,4),(2,1,1),(2,4,1),(2,1,2),(2,4,2),(2,1,3),(2,4,3),(2,1,4),(2,4,4);
...
-- Dump completed on 2020-01-22 10:56:39
