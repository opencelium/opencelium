...
public class ApplyOperatorException extends Exception {
    ...
    public String getMessage() {
        return switch (this.code) {
            case AO_INVALID_OPERAND_PAIRS -> "'%s' operator doesn't support these pairs. 1-operand '%s', 2-operand '%s'"
                    .formatted(this.operator.getName(), this.o1, this.o2);
            ...
            case AO_INVALID_TYPE -> "'%s' operator doesn't support this operand: '%s'"
                    .formatted(this.operator, this.o1);
