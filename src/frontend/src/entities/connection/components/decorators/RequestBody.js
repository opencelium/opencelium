        ...
        return class C extends React.Component {
						...
						return (
							<Dialog
								actions={[
									{
										label: 'Ok',
										onClick: () => this.updateEnhancement(),
										id: 'body_ok',
									},
									{
										label: 'Cancel',
					...
					renderDialogImportJson() {
						...
						return (
							<Dialog
								actions={[
									{ label: 'Ok', onClick: () => this.importJson() },
									{ label: 'Cancel', onClick: () => this.toggleImportJson() },
								]}
						...
						return (
							...
							>
								...
								<Component
									...
									onReferenceClick={
										hasReferenceComponent
											? typeof openEnhancement === 'function'
												? openEnhancement
												: (a, b) => this.openEnhancement(a, b)
											: null
									}
								/>
