...
import {HTTPRequestHeaders} from "@entity/connection/components/utils/constants/HTTPRequestHeaders";
            ...
            if(itemValue) {
                ...
                return (
                    <div
                        ...
                        onMouseLeave={(a) => this.hideDeleteButton(a)}
                        ...
                        <HeaderKey
                            ...
                            item={item}
                            itemValue={itemValue}
                            handleChange={(a, b, c) => this.handleChange(a, b, c)}
                            onFocusValue={(a) => this.onFocusValue(a)}
                            onBlurValue={(a) => this.onBlurValue(a)}
                        />
                        <HeaderValue
                            item={item}
                            readOnly={readOnly}
                            onFocus={(a) => this.onFocusValue(a)}
                            onBlur={(a) => this.onBlurValue(a)}
        ...
        return (
            <div>
                <FormSelect
                    ...
                    handleChange={(a) => this.changeHeaderProp(a)}
                    entity={{}}
                    hasHintTour={true}
                    onFocus={(a) => this.onFocusValue(a)}
                    onBlur={(a) => this.onBlurValue(a)}
                ...
                <div className={styles.invoker_item_add_button}>
                    <TooltipFontIcon isButton={true} value={'add'} tooltip={'Add Header'} onClick={(a) => this.addItem(a)} iconStyles={{cursor: 'pointer'}}/>
                </div>
                <Input
                    onChange={(a) => this.changeHeaderVal(a)}
                    name={'header_val'}
