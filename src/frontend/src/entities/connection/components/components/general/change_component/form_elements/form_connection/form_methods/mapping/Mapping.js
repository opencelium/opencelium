...
import {isArray, setFocusById} from "@application/utils/utils";
...
import {
    STATEMENT_REQUEST,
    STATEMENT_RESPONSE
} from "@entity/connection/components/classes/components/content/connection/operator/CStatement";
...
class Mapping extends Component{
    ...
    render(){
        ...
        model.addListener({portOnClick: (a) => this.onClickPort(a)});
