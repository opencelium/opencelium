  ...
  render() {
    ...
    return (
      ...
      >
        ...
        <ButtonPanel readOnly={data.readOnly} data={data} entity={entitys} updateEntity={updateEntity} currentTechnicalItem={currentTechnicalItem} setCurrentTechnicalItem={setCurrentTechnicalItem} />
{/*        <LogPanel />*/}
