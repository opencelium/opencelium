        ...
        switch (operator.type){
            case IF_OPERATOR:
                return <IfOperator
                    ...
                    toggleIsVisibleMenuEdit={(a) => this.toggleIsVisibleMenuEdit(a)}
                    renderCloseMenuEditButton={(a) => this.renderCloseMenuEditButton(a)}
    ...
    render(){
        ...
        return (
            <div
                ...
                onMouseEnter={(a) => this.showDeleteButton(a)}
