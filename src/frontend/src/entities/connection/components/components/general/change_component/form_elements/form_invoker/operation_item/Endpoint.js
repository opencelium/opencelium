...
import { transformDataFields } from '../../form_connection/form_svg/utils';
/**
...
class Endpoint extends Component{
    ...
    constructor(props){
        ...
        this.state = {
            endpoint: transformDataFields(props.operation.request.endpoint),
        };
    }
    ...
    componentDidMount(){
        ...
        if(endpoint === ''){
            this.setState({
                endpoint: transformDataFields(endpoint) 
            });
        }
    }
