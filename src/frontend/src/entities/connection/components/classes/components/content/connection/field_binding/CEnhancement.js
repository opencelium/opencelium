...
export default class CEnhancement {
	...
	static createEnhancement(enhancement) {
		let enhancementId =
			enhancement && enhancement.hasOwnProperty('enhancementId')
				? enhancement.enhancementId
				: 0;
		let name =
			enhancement && enhancement.hasOwnProperty('name') ? enhancement.name : '';
		let description =
			enhancement && enhancement.hasOwnProperty('description')
				? enhancement.description
				: '';
		let language =
			enhancement && enhancement.hasOwnProperty('language')
				? enhancement.language
				: 'js';
		let simpleCode =
			enhancement && enhancement.hasOwnProperty('simpleCode')
				? enhancement.simpleCode
				: null;
		let expertVar =
			enhancement && enhancement.hasOwnProperty('expertVar')
				? enhancement.expertVar
				: '';
		let expertCode =
