...
const cards = [
    ...
    {id: 5, name: 'External Applications', link: '/apps'},
    ...
    {id: 11, name: 'Swagger API Docs', link: `${baseUrl}docs`, isExternalHref: true},
    {id: 12, name: 'License Management', link: `/license_management`},
    {id: 13, name: 'Migration', link: `/migration`},
    {id: 14, name: 'Categories', link: `/categories`},
]
