...
const DataAggregatorDialogForm: FC<AggregatorFormProps> = ({
	...
	const [scriptSegment, setScriptSegment] = useState<string>(
							...
							{!showAssignedItemsSelect && (
								...
								>
									<CheckboxStyled
										...
										onChange={() =>
											toggleAssignedItemsSelect(!showAssignedItemsSelect)
										}
									/>
									<TextStyled
										hasCheckbox={true}
								...
								>
									<Select
										...
										options={
											allMethods.length > 0
												? allMethods
												: [{ label: 'No params', value: 0, color: 'white' }]
										}
										closeOnSelect={false}
										placeholder={'...'}
										isSearchable={true}
