...
import {NTBodyInputStep} from "@entity/notification_template/utils/tourSteps";
...
export class Content extends HookStateClass implements IContent {
	...
	static createState<T>(args?: Partial<IContent>, observation?: any): T {
		return super.createState<IContent>(
			Content,
	...
	getTextarea(
		data: IInput<IContentTextarea, InputTextareaProps>
	): ReactElement {
