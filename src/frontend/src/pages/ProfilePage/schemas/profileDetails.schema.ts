...
export const profileDetailsSchema = z.object({
    ...
    name: z.string().min(1, 'profile.validation.required').max(50),
    surname: z.string().min(1, 'profile.validation.required').max(50),
    ...
    phoneNumber: z
        ...
        .or(z.literal(''))
        .optional(),
    email: z.string().email().min(1, 'profile.validation.required').max(100),
})
