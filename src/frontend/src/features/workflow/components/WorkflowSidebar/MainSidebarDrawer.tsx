	...
	return (
		...
		>
			<SidebarSearch
				...
				testId='workflow-sidebar-search-main'
			...
			{props.hasSearch ? (
				props.isFetching ? (
					...
					<>
						{props.connectorItems.length > 0 && <SidebarList items={props.connectorItems} testIdPrefix='workflow-sidebar-search-connector' onSelect={props.onSelectConnector} />}
						{props.operatorItems.length > 0 && <SidebarList items={props.operatorItems} testIdPrefix='workflow-sidebar-search-operator' onSelect={props.onSelectOperator} />}
						{props.methodItems.length > 0 && <SidebarList items={props.methodItems} testIdPrefix='workflow-sidebar-search-method' onSelect={props.onSelectMethod} />}
					</>
				)
			) : (
				<>
					<SidebarList items={props.defaultItems} onSelect={props.onSelectMain} testIdPrefix='workflow-sidebar-main' />
					<button className='sidebarItem sidebarItemStandalone' type='button' data-testid='workflow-sidebar-main-item-trigger-connection' onClick={props.onSelectTriggerConnection}>
