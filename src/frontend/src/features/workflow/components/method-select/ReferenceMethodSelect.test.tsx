...
vi.mock('../request-editor/body-editor/MethodConnectorChip/MethodConnectorChip', () => ({ MethodConnectorChip: () => null }))
...
const TEST_ID = 'workflow-reference-method-select'

const renderSelect = (autoFocus?: boolean) => render(
    <ReferenceMethodSelect methods={methods} methodId={undefined}
        testId={TEST_ID} onChange={vi.fn()} autoFocus={autoFocus} />,
)

const focusIsInSelect = () =>
    !!document.activeElement?.closest(`[data-testid="${TEST_ID}"]`)
