			...
			>
				...
				<div className='drawerBody historyBody'>
					<div className='historyScroll'>
						<HistoryPanelTimeline state={state} downloadingSnapshotId={downloadingSnapshotId}
							onSelect={selectVersion} onToggleExpand={toggleExpandedComment}
							onSave={saveComment} onDownloadTemplate={downloadTemplate} onDelete={requestDelete} />
					</div>
				</div>
			</aside>
		</>
