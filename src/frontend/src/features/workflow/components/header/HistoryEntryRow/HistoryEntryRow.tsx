...
import { formatTime } from '../HistoryPanel/historyPanel.utils';
import { WorkflowMenuItem } from '../WorkflowMenuItem/WorkflowMenuItem';
import type { HistoryEntryRowProps } from './HistoryEntryRow.types';

export function HistoryEntryRow(props: HistoryEntryRowProps) {
