...
import type { MethodConnectorChipProps } from './MethodConnectorChip.types';

export function MethodConnectorChip({ method, iconOnly = false, iconSize = 16, tooltipZIndex, disableTooltip = false }: MethodConnectorChipProps) {
