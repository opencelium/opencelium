...
import {
    ...
    RemoveButtonStyled, TitleStyled,
    WidgetItemStyled
} from './styles';
import {MonitoringBoardsWidget} from "@organism/widgets/MonitoringBoardsWidget";
import {ConnectionOverviewWidget} from "@organism/widgets/ConnectionOverviewWidget";
import {CurrentSchedulesWidget} from "@organism/widgets/CurrentSchedulesWidget";
import {useAppDispatch} from "../../../hooks/redux";
import {getAllWidgetSettings, updateAllWidgetSettings} from "@action/dashboard/WidgetSettingCreators";
import {Widget} from "@class/dashboard/Widget";
import {WidgetSetting} from "@class/dashboard/WidgetSetting";
import Button from "@atom/button/Button";
import {API_REQUEST_STATE} from "@interface/application/IApplication";
import {IWidgetSetting} from "@interface/dashboard/IWidgetSetting";
import {ColorTheme} from "../../general/Theme";
import {DashboardToolbox} from "@organism/dashboard_toolbox/DashboardToolbox";
