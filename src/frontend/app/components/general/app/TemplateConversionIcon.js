    ...
    render(){
        ...
        return(
            <React.Fragment>
                {
                    invalidVersion &&
                    <TooltipFontIcon turquoiseTheme isButton={true} className={classNameIcon} iconStyles={styleIcon} tooltip={'Upgrade'} value={isLoading ? 'loading' : 'replay'} onClick={::this.convert} size={'24px'}/>
                }
            </React.Fragment>
        );
    }
