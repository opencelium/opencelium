...
import GraphiQLEditor from "@change_component/form_elements/form_connection/form_methods/method/GraphiQLEditor";

function mapStateToProps(state){
    const connector = state.get('connectors');
    return{
        connectors: connector.get('connectors').toJS(),
    }
}
