...
class DeleteIcon extends React.Component{
    ...
    render(){
        ...
        return(
            <svg x={svgX} y={svgY}>
                <path id={'delete_icon'} className={styles.process_delete} x={x} y={y} onClick={::this.toggleConfirmation} xmlns="http://www.w3.org/2000/svg" d="M6 19c0 1.1.9 2 2 2h8c1.1 0 2-.9 2-2V7H6v12zM19 4h-3.5l-1-1h-5l-1 1H5v2h14V4z">
                    <title>{'Delete'}</title>
                </path>
                <Confirmation
