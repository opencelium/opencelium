...
/**
 * Component of User to display avatar information
 */
...
class AvatarArea extends Component{
    ...
    render(){
        ...
        let classNames = ['user_details_email',
            'user_details_avatar',
            'user_details_last_login',
            'user_details_actions',
            'user_details_action',
            'user_details_email_xs',
            'user_details_avatar_xs',
            'user_details_last_login_xs',
            'user_details_actions_xs',
            'user_details_action_xs',
            'user_details_avatar_area',
            ...
            <Col xs={12} sm={6} md={6}>
                <Row className={styles[classNames.user_details_avatar_area]}>
                    ...
                    <div className={lastLoginStyle}>
                        <div>{t("VIEW.LAST_LOGIN")}: {userDetail.requestTime ? userDetail.requestTime : '-'}</div>
                    </div>
                </Row>
            </Col>
        );
