        ...
        return(
            class C extends React.Component{
                ...
                constructor(props){
                    ...
                    this.isAdd = type === 'add';
                    this.actionName = '';
                    if(this.isUpdate) this.actionName = `updatingUser`;
                    if(this.isAdd) this.actionName = `addingUser`;
                    this.state = {
                        validationMessages: {
                            name: '',
                            surname: '',
                ...
                parseEntity(){
                    if(this.isUpdate || this.isView) {
                        ...
                        result.userGroup = this.isView ? user.userGroups.name : user.userGroups.groupId;
                ...
                render(){
                    ...
                    const isActionInProcess = this.props.hasOwnProperty(this.actionName) && this.props[this.actionName] === API_REQUEST_STATE.START || checkingUserEmail === API_REQUEST_STATE.START;
                    return (
                        <React.Fragment>
                            <Form
                                contents={contents}
