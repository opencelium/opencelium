            ...
            render(){
                ...
                const additionalButtons = (entity) => {
                    ...
                    return(
                        <React.Fragment>
                            {button}
                            <div style={{float: 'left'}}><AddTemplate data={contents[2].inputs[1]} entity={entity} disabled={entity.isEmpty()} buttonProps={{icon: 'add', title: t(`${this.translationKey}.FORM.ADD_TEMPLATE`)}}/></div>
                        </React.Fragment>
                    );
                }
                return (
