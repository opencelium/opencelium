...
export const FUNCTIONAL_OPERATORS = [
    ...
    {value: 'AllowList',isMultiline:true,popupInputStyles:{width: '350px'},label: <span>AllowList({OPERATOR_LABELS.ALLOW_LIST})</span>, hasValue: true, isRightStatementText: true, placeholderValue: OPERATOR_LABELS.ALLOW_LIST},
    {value: 'DenyList',isMultiline:true,popupInputStyles:{width: '350px'},label: <span>DenyList({OPERATOR_LABELS.DENY_LIST})</span>, hasValue: true, isRightStatementText: true, placeholderValue: OPERATOR_LABELS.DENY_LIST},
